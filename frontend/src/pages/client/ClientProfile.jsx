    ...
    <div style={{ padding: "40px" }}>
      ...
      {currentQueue ? (
        ...
        <div>
          ...
          <p><strong>Barbería:</strong> {currentQueue.barbershop}</p>
          <p><strong>Barbero:</strong> {currentQueue.barber}</p>
          <p><strong>Tu posición:</strong> {currentQueue.position}</p>
          <p><strong>Tiempo estimado:</strong> {currentQueue.estimatedTime}</p>
