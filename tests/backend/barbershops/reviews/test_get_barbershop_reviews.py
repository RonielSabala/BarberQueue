"""
Tests for GET /api/barbershops/{id}/reviews
"""
...
def response(
    ...
    create_review_response: requests.Response,
) -> requests.Response:
    return client.barbershops.get_reviews(open_barbershop_id)


def test_status(response: requests.Response) -> None:
    """
    Successful reviews listing returns 200.
    """
...
def test_status_on_unknown_barbershop(client: ApiClient) -> None:
    ...
    response = client.barbershops.get_reviews(NON_EXISTENT_ID)
